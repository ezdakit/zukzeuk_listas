...
#
# CHANGELOG:
# - [v1.3] Implementada lógica de normalización en 'canal_agenda'.
#          Reglas aplicadas: ELLAS VAMOS->MOVISTAR ELLAS, M+ DEPORTES->MOVISTAR DEPORTES,
#          HYPERMOTION, DAZN LA LIGA, eliminación de ": VER PARTIDO", PLUS+->PLUS,
#          y eliminación de prefijo "M+ ".
# - [v1.2] Añadida columna 'canal_agenda' en eventos_canales.csv.
# - [v1.1] Añadido .upper() en clean_channel_name para forzar mayúsculas globales.
# - [v1.0] Versión estable original. Lógica de diales estricta.
# ============================================================================================
    ...
    for day_div in days:
        ...
        for row in rows:
            ...
            for ch in channels:
                ...
                # --- [v1.3] EXTRACCIÓN Y NORMALIZACIÓN DE CANAL AGENDA ---
                dial = None
                ...
                # 2. Normalización Estricta [v1.3]
                canal_agenda_clean = canal_agenda_clean.upper().strip()
                
                # Reglas secuenciales solicitadas:
                ...
                canal_agenda_clean = canal_agenda_clean.replace(" : VER PARTIDO", "")
                canal_agenda_clean = canal_agenda_clean.replace("PLUS+", "PLUS")
                
                if canal_agenda_clean.startswith("M+ "):
                    canal_agenda_clean = canal_agenda_clean[3:].strip()
                # ---------------------------------------------------------
